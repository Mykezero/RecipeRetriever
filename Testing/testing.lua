...
---------------------------------------------------------------------------------------------------
purpose: makes retrieving ffxi recipes easier by allow the user to specify certain
characteristic of a recipe and retrieve recipe's with those characteristics.
---------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------
TODO:
- 	Add functionality to support getting a recipe by name.
...
_addon.name = 'Testing'		-- Name of the addon.
...
-------------------------------------------------------------------------------
-- func: printRecipe
-- desc: prints a recipe by id in a friendly format
-------------------------------------------------------------------------------
